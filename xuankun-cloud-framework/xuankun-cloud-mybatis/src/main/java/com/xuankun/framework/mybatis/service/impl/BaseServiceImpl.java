package com.xuankun.framework.mybatis.service.impl;
...
import com.xuankun.framework.mybatis.interceptor.DataScope;
import com.xuankun.framework.common.query.DbQuery;
import com.xuankun.framework.mybatis.service.BaseService;
import com.xuankun.framework.security.user.SecurityUser;
...
public class BaseServiceImpl<M extends BaseMapper<T>, T>  extends ServiceImpl<M, T> implements BaseService<T> {
     ...
     * @param query   分页参数
     */
    protected IPage<T> getPage(DbQuery query) {
    ...
    protected QueryWrapper<T> getWrapper(DbQuery query) {
