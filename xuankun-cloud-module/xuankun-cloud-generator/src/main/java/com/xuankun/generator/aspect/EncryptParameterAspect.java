...
public class EncryptParameterAspect {
     ...
     * @throws Throwable
     */
    @Around("execution(* com.xuankun.generator.controller.DataSourceController.*(..))")
    ...
    private void handleItem(Object item, boolean isDecrypt) {
        ...
        // 只处理在entity包下面的对象
        if (Objects.isNull(item.getClass().getPackage()) || !item.getClass().getPackage().getName().startsWith("com.xuankun.generator.entity")) {
            return;
        }
