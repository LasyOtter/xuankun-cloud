...
import com.xuankun.framework.common.enums.FormLayoutEnum;
import com.xuankun.framework.common.enums.GeneratorTypeEnum;
...
import com.xuankun.generator.config.template.GeneratorInfo;
import com.xuankun.generator.dao.TableDao;
...
import com.xuankun.generator.service.TableFieldService;
import com.xuankun.generator.service.TableService;
...
public class TableServiceImpl extends BaseServiceImpl<TableDao, TableEntity> implements TableService {
    ...
    @Override
    public PageResult<TableEntity> page(DbQuery query) {
